...
<body>
	...
	<div class="section-top-border" style="text-align: center;">
		<div class="section-top-border" style="margin: 0 auto; width: 480px;">
			<div>
				<h4 style="text-align: left;">이메일주소</h4>
				<div class="mt-10">
					<input type="text" name="email" placeholder="이메일을 입혁하세요"
						class="single-input">
				</div>
				<hr>
				<h4 style="text-align: left;">대표자명</h4>
				<div class="mt-10">
					<input type="text" name="ceo" placeholder="대표자명을 입력하세요"
						class="single-input">
				</div>
				<br> <br>
				<button class="genric-btn info e-large" onclick="checkPw();" style="width: 300px; font-size: x-large; font-weight: bold;"> 비밀번호 재설정</button>
