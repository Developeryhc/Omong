		...
		<div class="row">
			<div class="col-lg-8 col-md-8">
				...
				<div class="mt-10">
					...
					<button class="genric-btn info-border" onclick="checkPw();">확인</button>
				</div>
				<hr>
				<form action="/partnerPwChange.do" method="post">
					<h4>새 비밀번호</h4>
					<input name="id" type="hidden" value="${sessionScope.u.id }">
					<input type="password" name="pw" placeholder="새 비밀번호" required
						class="single-input"
						style="float: left; width: 60%; margin-right: 20%;"> 
					<button class="genric-btn info-border" type="submit" >변경</button>
				</form>
			</div>
		</div>
	</div>
