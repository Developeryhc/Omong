			...
			<form action="/planDetail.do" method="GET">
				<div style="margin-bottom: 10px;">
					<div class="percentage">
						<input name="planWriter" type="hidden"
				...
				<div style="margin-bottom: 10px;">
					...
					<div class="percentage">
						<input name="planStart" type="text" id="sDatepicker"> ~ <input
							name="planEnd" id="eDatepicker" type="text">
					</div>
				</div>
				<hr>
				<div style="margin-bottom: 10px;">
				...
				<h4>썸네일</h4>
				<ul class="slider">
					<li><img src="/resources/img/jeju/제주_1.jpg" /></li>
					<li><img src="/resources/img/jeju/제주_2.jpg" /></li>
					<li><img src="/resources/img/jeju/제주_3.jpg" /></li>
					<li><img src="/resources/img/jeju/제주_4.jpg" /></li>
					<li><img src="/resources/img/jeju/제주_5.jpg" /></li>
					<li><img src="/resources/img/jeju/제주_6.jpg" /></li>
					<li><img src="/resources/img/jeju/제주_7.jpg" /></li>
					<li><img src="/resources/img/jeju/제주_8.jpg" /></li>
					<li><img src="/resources/img/jeju/제주_9.jpg" /></li>
						...
						<div class="copyright_part_text text-center">
							<p class="footer-text m-0">
								...
								All rights reserved | This template is made with <i
									class="ti-heart" aria-hidden="true"></i> by <a target="_blank"
									id="dblclick"> (주) 모들</a>
								<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
							</p>
						</div>
